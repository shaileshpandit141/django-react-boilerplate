...
SECRET_KEY = "django-insecure-cl#87z#%942=b$bh$#59v@eb@@-1ortj49#lv9$dyw%@p=%k8h"
...
# Define Staticfiles directory to store the static files
# STATICFILES_DIRS = [
#     BASE_DIR / 'static/'
# ]

# Static URL used to access the StaticFiles
STATIC_URL = "static/"
